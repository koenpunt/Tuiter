...
Tuiter.prototype.getStream = function(url, params, callback){
  var stream = this.oa.get(url + '?' + qs.stringify(params), this.oa.access_token_key, this.oa.access_token_secret);
...
Tuiter.prototype.postStream = function(url, params, callback){
  var stream = this.oa.post(url, this.oa.access_token_key, this.oa.access_token_secret, params);
  handleStream(stream, callback);
...
var handleStream = function(stream, callback){
  var buf = '';
